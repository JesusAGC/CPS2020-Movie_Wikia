...
############  Get All Actors ################################################
    def test_get_all_actors(self):
        ...
        database_workclass.delete_actor(self,set_1)
        database_workclass.delete_actor(self,set_2)
################# Get all Movies ############################################
    def test_get_all_movies(self):
        ...
        for x in range(len(movie_list)):
            ...
            self.assertEqual(movie_list[x].date_of_release,sets[x].date_of_release)
            self.assertEqual(movie_list[x].overview,sets[x].overview)
        database_workclass.delete_movie(self,set_1)
        database_workclass.delete_movie(self,set_2)
...
################# Update Movie BD #################################################
    def test_update_movie(self):
        set_2 = Movie(76341,'Mad Max: Fury Road','2015-05-13','An apocalyptic story set in the furthest reaches of our planet, in a stark desert landscape where humanity is broken, and most everyone is crazed fighting for the necessities of life. Within this world exist two rebels on the run who just might be able to restore order.')
        database_workclass.insert_movie(self,set_2)
        set_3 = Movie(76341,'Cad Max: Fury Road','2015-05-13','An apocalyptic story set in the furthest reaches of our planet, in a stark desert landscape where humanity is broken, and most everyone is crazed fighting for the necessities of life. Within this world exist two rebels on the run who just might be able to restore order.')
        database_workclass.update_movie(self,set_3)
        
        set_1 = Movie(76341,'Cad Max: Fury Road','2015-05-13','An apocalyptic story set in the furthest reaches of our planet, in a stark desert landscape where humanity is broken, and most everyone is crazed fighting for the necessities of life. Within this world exist two rebels on the run who just might be able to restore order.')
        film = database_searchs.search_movie_by_id(self,76341)
        self.assertEqual(film.movie_id,set_1.movie_id)
        self.assertEqual(film.title,set_1.title)
        self.assertEqual(film.date_of_release,set_1.date_of_release)
